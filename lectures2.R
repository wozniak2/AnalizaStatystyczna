...
# TODO: adjust your path!
poly = vect("c:/.../powiat_sremski.gpkg")

# TODO: adjust your path!
# wczytuje informacje o klasach pokrycia terenu
cat = rast("c:/.../S2GLC_T33UXT.tif")
leg = read.csv("c:/.../S2GLC_T33UXT.csv")
...
# Nasze równanie regresji to: y = 8.43 + 0.047*x, 
# czyli sprzedaż = 8.43 + 0.047*youtube.
...
#sprzedaż = b0 + b1*youtube + b2*facebook + b3*gazeta
...
# Ten model jest lepszy niż model regresji prostej (tylko youtube), 
# który miał skorygowane R2 = 0.61.
